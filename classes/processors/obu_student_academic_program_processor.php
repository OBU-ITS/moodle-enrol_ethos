...
use enrol_ethos\services\sync\obu_sync_student_academic_program_service;
use progress_trace;
...
class obu_student_academic_program_processor implements obu_processor {
    ...
    private obu_sync_student_academic_program_service $syncService;

    private progress_trace $trace;

    public function __construct($trace)
    {
        $this->syncService = obu_sync_student_academic_program_service::getInstance();
